...
class layout_Default_html_9957a0354b3bb53cd9af724358ee27d3978e5122 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="last-section content-layout d-flex">
  <div class="last-left-container w-50 d-flex flex-row p-3">
    <div class="red-rectangle border border-danger font-weight-bold text-danger p-3">POS 1</div>
    <div class="red-rectangle border border-danger font-weight-bold text-danger p-3">POS 2</div>
    <div class="red-rectangle border border-danger font-weight-bold text-danger p-3">POS 3</div>
    <div class="red-rectangle border border-danger font-weight-bold text-danger p-3">POS 4</div>
  </div>
...
$arguments115['partial'] = 'FilledButton';
// Rendering Array
$array117 = array();
$array117['buttonName'] = 'Tarif abschließen';
$array117['style'] = 'w-25';

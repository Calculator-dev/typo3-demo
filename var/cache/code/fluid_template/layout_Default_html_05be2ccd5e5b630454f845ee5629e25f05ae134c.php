...
class layout_Default_html_05be2ccd5e5b630454f845ee5629e25f05ae134c extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output96 .= TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments99, $renderChildrenClosure100, $renderingContext);
...
$arguments101['partial'] = 'Card';
// Rendering Array
$array103 = array();
$array104 = array (
);$array103['svg'] = $renderingContext->getVariableProvider()->getByPath('myvariable', $array104);
$arguments101['arguments'] = $array103;

$output96 .= TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments101, $renderChildrenClosure102, $renderingContext);

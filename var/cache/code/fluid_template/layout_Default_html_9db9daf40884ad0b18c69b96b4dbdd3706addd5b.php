...
class layout_Default_html_9db9daf40884ad0b18c69b96b4dbdd3706addd5b extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="footer content-layout d-flex flex-column justify-content-center align-items-center" >
  ...
  <div class="icons d-flex">
    <img class="icon" alt="facebook" width="30" height="30" src="https://upload.wikimedia.org/wikipedia/en/0/04/Facebook_f_logo_%282021%29.svg" />
    <img class="icon" alt="youtube" width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/8/8b/YouTube_dark_icon_%282017%29.svg" />
    <img class="icon" alt="youtube" width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/a/a5/Twitter_bird_logo_black.svg" />
    <img class="icon" alt="youtube" width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/6/6e/Instagram_font_awesome.svg" />
    <img class="icon" alt="youtube" width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/7/76/Font_Awesome_5_brands_linkedin.svg" />
  </div>
</div>';

...
class layout_Default_html_324b2d682c2189c8bc26f8a40e685311d7a6fbc7 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
    ...
    >
      ...
      <div class="new-price d-flex flex-row text-5 text-white">
        ...
        <div class="old-price-container text-white">
          <p class="m-0 test big-letter" style="height: auto">90 € m</p>
        </div>
      </div>
    </div>
  </div>

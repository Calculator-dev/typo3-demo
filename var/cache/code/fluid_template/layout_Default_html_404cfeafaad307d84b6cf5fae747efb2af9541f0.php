...
class layout_Default_html_404cfeafaad307d84b6cf5fae747efb2af9541f0 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
    ...
    >
      ...
      <div class="new-price border d-flex flex-column text-5 text-white">
        ...
        <div class="old-price-container d-flex flex-column text-white">
          <p class="m-0 test" style="height: auto">
            9, 90 <br />
            € m
          </p>
        </div>

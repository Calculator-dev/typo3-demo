...
class layout_Default_html_6714c887a34d4ce4b7647ad2c33433f4800a7edd extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="last-section content-layout d-flex">
  <div class="last-left-container w-50 d-flex flex-row">
    <div class="red-rectangle border border-danger text-danger">POS 1</div>
    <div class="red-rectangle border border-danger">POS 2</div>
    <div class="red-rectangle border border-danger">POS 3</div>
    <div class="red-rectangle border border-danger">POS 4</div>
  </div>

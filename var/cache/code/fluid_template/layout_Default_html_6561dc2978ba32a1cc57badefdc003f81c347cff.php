...
class layout_Default_html_6561dc2978ba32a1cc57badefdc003f81c347cff extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="container-fluid bg-hero-gradient">
  <div class="left-container">
    ...
    >
      ...
      <div class="new-price d-flex flex-row text-white">
        <h1 class="m-0">9</h1>
        <div>
          <p class="m-0 d-inline-block test" style="height: auto">90</p>
          <p class="m-0">€ m</p>
          <p class="m-0">,</p>
        </div>
      </div>

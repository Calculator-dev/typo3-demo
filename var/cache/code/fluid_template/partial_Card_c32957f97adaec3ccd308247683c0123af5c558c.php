...
class partial_Card_c32957f97adaec3ccd308247683c0123af5c558c extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('cardTitle', $array1)]);

$output0 .= '</h5>
      <p class="card-text">';
$array2 = array (
);
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('cardText', $array2)]);
...
$arguments3['partial'] = 'OutlinedButton';
// Rendering Array
$array5 = array();
$array6 = array (
);$array5['buttonName'] = $renderingContext->getVariableProvider()->getByPath('buttonName', $array6);
$array5['style'] = 'float-right';

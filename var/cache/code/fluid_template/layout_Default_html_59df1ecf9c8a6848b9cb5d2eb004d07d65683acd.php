...
class layout_Default_html_59df1ecf9c8a6848b9cb5d2eb004d07d65683acd extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
    ...
    <div class="surfen-und-telefonieren-left-continer d-flex flex-column">
      ...
      <div class="d-flex flex-column justify-content-between">
        <div class="d-flex flex-row align-items-center">
          ...
          <h5>Top Uploadraten bis zu 300 M</h5>
        </div>
        <div>cao</div>
        <div>cao</div>
        <div>cao</div>

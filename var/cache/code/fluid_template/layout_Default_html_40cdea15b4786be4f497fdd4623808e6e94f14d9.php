...
class layout_Default_html_40cdea15b4786be4f497fdd4623808e6e94f14d9 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
// Rendering Array
$array93 = array();
$array93['otherSections'] = 'Nur Für Kurze Zeit';
$array93['price'] = 9;
...
$array105['otherSections'] = 'Nur Für Kurze Zeit';
...
$array111['otherSections'] = 'Nur Für Kurze Zeit';
...
// Rendering Array
$array117 = array();
$array117['className'] = 'last-section-price';
$array117['price'] = 29;
$array117['pricePenny'] = 90;
$array117['left'] = '20%';
$array117['position'] = 'position-absolute';
$array117['lastSection'] = 'Fur Junge Leute';
$array117['megabytes'] = 100;
...
<div class="footer  d-flex flex-column justify-content-center align-items-center" >
  <div class="footer-pages d-flex font-weight-bold">
    <h4>Impressum</h4>
    <h4>Datenschutz</h4>
    <h4>AGB</h4>
  </div>
  <p>©2006-2020 M-net Telekommunikations GmbH</p>
  <div class="icons d-flex">
    <img  alt="facebook" width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/c/c3/Facebook_icon_%28black%29.svg" />
    <img  alt="youtube" width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/8/8b/YouTube_dark_icon_%282017%29.svg" />
    <img  alt="twitter" width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/a/a5/Twitter_bird_logo_black.svg" />
    <img  alt="instagram" width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/6/6e/Instagram_font_awesome.svg" />
    <img  alt="linkedin" width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/7/76/Font_Awesome_5_brands_linkedin.svg" />
  </div>
</div>
';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper
...
$arguments121['section'] = 'Main';

$output0 .= TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments121, $renderChildrenClosure122, $renderingContext);
...
$arguments123['maxDepth'] = 8;
$arguments123['plainText'] = false;
$arguments123['ansiColors'] = false;
$arguments123['inline'] = false;
$arguments123['blacklistedClassNames'] = NULL;
$arguments123['blacklistedPropertyNames'] = NULL;

$output0 .= TYPO3\CMS\Fluid\ViewHelpers\DebugViewHelper::renderStatic($arguments123, $renderChildrenClosure124, $renderingContext);

...
class layout_Default_html_0b50e151c1451d6a786342dad83a5c9813795805 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments96 = array();
$arguments96['src'] = '';
$arguments96['treatIdAsReference'] = false;
$arguments96['image'] = NULL;
$arguments96['crop'] = NULL;
$arguments96['cropVariant'] = 'default';
$arguments96['fileExtension'] = NULL;
$arguments96['width'] = NULL;
$arguments96['height'] = NULL;
$arguments96['minWidth'] = NULL;
$arguments96['minHeight'] = NULL;
$arguments96['maxWidth'] = NULL;
$arguments96['maxHeight'] = NULL;
$arguments96['absolute'] = false;
$array98 = array (
);$arguments96['image'] = $renderingContext->getVariableProvider()->getByPath('test', $array98);

$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [TYPO3\CMS\Fluid\ViewHelpers\Uri\ImageViewHelper::renderStatic($arguments96, $renderChildrenClosure97, $renderingContext)]);
...
$arguments99['partial'] = 'Card';
// Rendering Array
$array101 = array();
$array102 = array (
);$array101['svg'] = $renderingContext->getVariableProvider()->getByPath('test', $array102);
$arguments99['arguments'] = $array101;

$output0 .= TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments99, $renderChildrenClosure100, $renderingContext);
...
$arguments105['partial'] = 'Card';

$output0 .= TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments105, $renderChildrenClosure106, $renderingContext);

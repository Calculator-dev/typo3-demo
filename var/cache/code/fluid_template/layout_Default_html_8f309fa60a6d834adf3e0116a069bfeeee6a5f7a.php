...
class layout_Default_html_8f309fa60a6d834adf3e0116a069bfeeee6a5f7a extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="container-fluid bg-hero-gradient">
  <div class="left-container">
    ...
    >
      ...
      <div class="text-white d-inline-flex border flex-row">
        <p class="m-0 lg-letter font-weight-bold">9 <span>,</span></p>
        <div class="d-inline-flex flex-column test">
          <span class="md-letter">90</span>
          <p class="m-0">€ mb</p>
        </div>
      </div>
    </div>

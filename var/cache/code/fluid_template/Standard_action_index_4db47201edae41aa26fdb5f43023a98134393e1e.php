...
class Standard_action_index_4db47201edae41aa26fdb5f43023a98134393e1e extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output260 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, ['']);

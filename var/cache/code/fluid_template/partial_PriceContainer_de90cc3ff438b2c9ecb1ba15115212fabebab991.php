...
class partial_PriceContainer_de90cc3ff438b2c9ecb1ba15115212fabebab991 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output44 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('megabytes', $array45)]);

$output44 .= '</p>
        <div
          class="d-inline-flex position-absolute flex-column secondary-price"
        >
          <p class="m-0 sm-letter">Mbit/s</p>
          <p class="m-0 sm-letter">fur</p>
        </div>
      </div>
    ';
return $output44;
...
$array38 = array();
$array39 = array (
);$array38['0'] = $renderingContext->getVariableProvider()->getByPath('megabytes', $array39);
...
$output35 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('megabytes', $array36)]);

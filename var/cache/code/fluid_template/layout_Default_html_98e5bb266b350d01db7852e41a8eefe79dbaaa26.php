...
class layout_Default_html_98e5bb266b350d01db7852e41a8eefe79dbaaa26 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
    ...
    >
      ...
      <div class="new-price border d-flex flex-column text-5 text-white">
        ...
        <div class="old-price-container d-flex flex-column text-white">
          <p class="m-0 test" style="height: auto">9 90 € m</p>
        </div>
      </div>
    </div>
  </div>

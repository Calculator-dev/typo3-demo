...
class layout_Default_html_c5bd1ba73240ac395d433790f72baeaee97749c3 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="container-fluid bg-hero-gradient">
  <div class="left-container">
    ...
    >
      ...
      <div class="new-price d-flex flex-row">
        <h1 class="m-0 text-white text-20">9</h1>
        <div>
          <p class="m-0 text-white">90</p>
          <p class="m-0 text-white">€ m</p>

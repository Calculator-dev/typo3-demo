...
class partial_PriceContainer_f9e947eca03007719386a4900a2ba5cc2f5bc2b5 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= ',</p>
  ...
  <script>
    // Check if oldPrice is true
    if (oldPrice) {
      // Show the div element
      document.getElementById("old-price-container").style.display = "block";
    }
  </script>';

...
class layout_Default_html_d2558f14b2a97f460dff02a8a5e86a0e57595f7f extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="container-fluid bg-hero-gradient">
  <div class="left-container">
    ...
    <div class="price position-absolute d-flex">
      ...
      <div class="old-price-container p-0 border d-inline-flex flex-column">
        <p class="m-0">statt</p>

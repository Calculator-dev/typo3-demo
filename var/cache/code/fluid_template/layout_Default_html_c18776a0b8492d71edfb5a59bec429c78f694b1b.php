...
class layout_Default_html_c18776a0b8492d71edfb5a59bec429c78f694b1b extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
  ...
  <div class="surfen-und-telefonieren-content d-flex justify-content-between">
    <div class="surfen-und-telefonieren-left-continer d-flex flex-column">
      ...
      <p>
        ...
        <br />Glasfaserverbindungen. Dadurch erreichen Sie nicht nur hohe <br />
      ...
      <div class="d-flex flex-column">
        <div class="d-flex flex-row">
          <img src="../../../Public/Images/BackendLayouts/done.svg" alt="" />
          <h1>cao</h1>
        </div>
        <div>cao</div>
        <div>cao</div>

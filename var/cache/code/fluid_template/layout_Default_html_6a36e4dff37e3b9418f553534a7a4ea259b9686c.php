...
class layout_Default_html_6a36e4dff37e3b9418f553534a7a4ea259b9686c extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="container-fluid bg-hero-gradient">
  <div class="left-container">
    ...
    <div class="price position-absolute">
      <div class="price-header btn-orange">Nur Für Kurze Zeit</div>
      <div class="old-price">
        <p>statt</p>
        <p>14,90 €</p>
      </div>

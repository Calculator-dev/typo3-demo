...
class layout_Default_html_84316fdd92cf4bcd3f4ee396ddf6c83e3c81bcb4 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
  ...
  <div class="left-container">
    ...
    >
      ...
      <div class="new-price d-flex flex-row text-white">
        <h1 class="m-0">9</h1>
        <div>
          <p class="m-0 d-inline-block" style="height: auto">90</p>
          <p class="m-0">€ m</p>
          <p class="m-0">,</p>
        </div>
      </div>

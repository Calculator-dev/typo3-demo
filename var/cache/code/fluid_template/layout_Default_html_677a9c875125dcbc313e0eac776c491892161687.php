...
class layout_Default_html_677a9c875125dcbc313e0eac776c491892161687 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
    ...
    >
      ...
      <div class="new-price d-flex flex-row text-5 text-white">
        ...
        <div class="d-inline-block">
          <p class="m-0 test" style="height: auto">90</p>
          <p class="m-0">€ m</p>
          <p class="m-0">,</p>
        </div>
      </div>

...
class layout_Default_html_5c3e0ed702bbc0d893a7ab945149f673310528da extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="container-fluid bg-hero-gradient">
  <div class="left-container">
    ...
    <div
      class="price position-absolute d-flex flex-row justify-content-between align-items-center"
    >
      <div class="price-header position-absolute btn-orange d-inline-block">
        Nur Für Kurze Zeit
      </div>
      <div class="old-price-container border d-inline-flex flex-column">
        <p class="m-0">statt</p>

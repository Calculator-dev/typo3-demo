...
class layout_Default_html_f2ae5497472dde9beef51466680115886e2739f1 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="container-fluid bg-hero-gradient">
  <div class="left-container">
    ...
    <div class="price position-absolute">
      <div
        class="price-header position-absolute m-auto btn-orange d-inline-block"
      >
        Nur Für Kurze Zeit
      </div>
      <div class="old-price">

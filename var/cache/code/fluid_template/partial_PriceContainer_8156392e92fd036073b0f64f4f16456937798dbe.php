...
class partial_PriceContainer_8156392e92fd036073b0f64f4f16456937798dbe extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= ',</p>
  ...
  <script>
    ...
    if (!oldPrice) {
      ...
      document.getElementById("old-price-container").style.display = "none";
    }
  </script>';

...
class layout_Default_html_58652009eff61bfeb2a5209e4ebee3f6f326f223 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="last-section content-layout d-flex">
  <div class="last-left-container w-50 d-flex flex-row p-3">
    <div class="red-rectangle border border-danger font-weight-bold text-danger">POS 1</div>
    <div class="red-rectangle border border-danger font-weight-bold text-danger">POS 2</div>
    <div class="red-rectangle border border-danger font-weight-bold text-danger">POS 3</div>
    <div class="red-rectangle border border-danger font-weight-bold text-danger">POS 4</div>
  </div>

...
class layout_Default_html_f3169901175ca79f70f112509a079735be08bd1d extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
    ...
    >
      ...
      <div class="new-price border d-flex flex-column text-5 text-white">
        ...
        <div class="old-price-container d-flex flex-column text-white">
          <p class="m-0 test" style="height: auto">90 € m</p>
        </div>
      </div>
    </div>
  </div>

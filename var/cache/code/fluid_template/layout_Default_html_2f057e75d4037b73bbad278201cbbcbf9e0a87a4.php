...
class layout_Default_html_2f057e75d4037b73bbad278201cbbcbf9e0a87a4 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="container-fluid bg-hero-gradient">
  <div class="left-container">
    ...
    <div class="price position-absolute">
      <div class="price-header btn-orange w-fit-content">
        Nur Für Kurze Zeit
      </div>
      <div class="old-price">
        <p>statt</p>

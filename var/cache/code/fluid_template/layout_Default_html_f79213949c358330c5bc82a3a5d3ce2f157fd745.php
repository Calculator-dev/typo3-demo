...
class layout_Default_html_f79213949c358330c5bc82a3a5d3ce2f157fd745 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="footer content-layout d-flex flex-column justify-content-center align-items-center" >
  ...
  <div class="icons d-flex">
    <img class="icon" alt="facebook" width="50" height="50" src="https://upload.wikimedia.org/wikipedia/en/0/04/Facebook_f_logo_%282021%29.svg" />
    <img class="icon" alt="youtube" width="50" height="50" src="https://upload.wikimedia.org/wikipedia/commons/8/8b/YouTube_dark_icon_%282017%29.svg" />
    <img class="icon" alt="youtube" width="50" height="50" src="https://upload.wikimedia.org/wikipedia/commons/4/4f/Twitter-logo.svg" />
    <img class="icon" alt="youtube" width="50" height="50" src="https://upload.wikimedia.org/wikipedia/commons/6/6e/Instagram_font_awesome.svg" />
    <img class="icon" alt="youtube" width="50" height="50" src="https://upload.wikimedia.org/wikipedia/commons/8/81/LinkedIn_icon.svg" />
  </div>
</div>';

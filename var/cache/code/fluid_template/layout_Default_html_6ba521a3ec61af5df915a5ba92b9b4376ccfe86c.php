...
class layout_Default_html_6ba521a3ec61af5df915a5ba92b9b4376ccfe86c extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="container-fluid bg-hero-gradient">
  <div class="left-container">
    ...
    <div
      class="price position-absolute d-flex flex-row justify-content-around align-items-center"
    >
      ...
      <div
        class="new-price border position-relative d-flex flex-column text-5 text-white"
      >
        <!-- <h1 class="m-0 font-weight-bold big-letter">9</h1> -->
        <div class="old-price-container d-flex flex-column text-white">
          <p class="m-0 test position-absolute" style="height: auto">
            9, 90 <br />
            € m
          </p>
        </div>

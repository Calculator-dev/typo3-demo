...
class layout_Default_html_80bd3459cf1f6b5029143bdd215914b85cff3cfd extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="last-section content-layout d-flex">
  <div class="last-left-container w-50"></div>
  <div class="last-right-container w-50 d-flex flex-column justify-content-around p-3">
    <h3>Profitieren sie unter 25 Jahren von unseren <br>
      attraktiven Sonderkonditionen.</h3>
      <div class="bullet-tags d-flex flex-column">
        <div class="bullet-tag p-2 bg-white rounded position-relative">
          Fixpreis über die gesamte Vertragslaufzeit
          <div class="blue-circle rounded-circle bg-primary position-absolute"></div>
        </div>
        <div class="bullet-tag p-2 bg-white rounded">

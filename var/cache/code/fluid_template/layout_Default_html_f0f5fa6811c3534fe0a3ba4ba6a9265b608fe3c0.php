...
class layout_Default_html_f0f5fa6811c3534fe0a3ba4ba6a9265b608fe3c0 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="container-fluid bg-hero-gradient">
  <div class="left-container">
    ...
    >
      ...
      <div class="text-white position-relative d-inline-flex border flex-row">
        <p class="m-0 lg-letter font-weight-bold">9,</p>
        <div class="d-inline-flex position-absolute flex-column test">

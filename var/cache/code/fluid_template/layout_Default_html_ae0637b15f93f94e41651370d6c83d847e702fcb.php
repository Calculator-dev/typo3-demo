...
class layout_Default_html_ae0637b15f93f94e41651370d6c83d847e702fcb extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<f:variable name="test" value="';

$output0 .= '{f:format.raw(\'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="svg-background"><path fill="#0070AE" d="M20.285 2l-11.285 11.567-5.286-5.011-3.714 3.716 9 8.728 15-15.285z"/></svg>\')}';

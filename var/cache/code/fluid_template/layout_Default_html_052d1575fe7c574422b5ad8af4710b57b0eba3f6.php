...
class layout_Default_html_052d1575fe7c574422b5ad8af4710b57b0eba3f6 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="container-fluid bg-hero-gradient">
  <div class="left-container">
    ...
    >
      ...
      <div class="text-white d-inline-flex border flex-column">
        <p class="m-0 lg-letter font-weight-bold">9</p>
        <div class="d-inline-flex flex-row test">

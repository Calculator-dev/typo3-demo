...
class partial_PriceContainer_6a58a38cf3895e9749840ea9113a1ba8a11cbfee extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array2 = array (
  0 => '{laptop ? laptop : left}',
  1 => '{laptop ? laptop : left}',
);
$ternaryExpression3 = function($context, $renderingContext) {
                $check = 'laptop';
                $parser = new \TYPO3Fluid\Fluid\Core\Parser\BooleanParser();
                $checkResult = $parser->evaluate($check, $context);
                if ($checkResult) {
                    return TYPO3Fluid\Fluid\Core\Parser\SyntaxTree\Expression\TernaryExpressionNode::getTemplateVariableOrValueItself('laptop', $renderingContext);
                }
                return TYPO3Fluid\Fluid\Core\Parser\SyntaxTree\Expression\TernaryExpressionNode::getTemplateVariableOrValueItself('left', $renderingContext);
			};

$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$ternaryExpression3(TYPO3Fluid\Fluid\Core\Parser\SyntaxTree\Expression\TernaryExpressionNode::gatherContext($renderingContext, $array2[1]), $renderingContext)]);

...
class List_action_index_97806ef85cb57dcd5abf60927d265934405c7d1a extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output292 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, ['']);

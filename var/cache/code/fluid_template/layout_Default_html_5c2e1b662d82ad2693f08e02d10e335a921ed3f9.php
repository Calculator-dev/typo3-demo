...
class layout_Default_html_5c2e1b662d82ad2693f08e02d10e335a921ed3f9 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
  ...
  <div class="left-container">
    ...
    >
      ...
      <div class="new-price d-flex flex-row text-5 text-white">
        <h1 class="m-0">9</h1>
        <div class="old-price-container d-inline-flex flex-row text-white">
